...
// // // import ParentAssessmentsList from "../components/ParentAssessmentsList";
...
// //   // 🆕 ספירת אבחונים שממתינים לתיאום (להצגת badge)
// //   const pendingAssessmentsCount =
// //     activeDiagnosis?.requiredAssessments?.filter((a) => a.status === "pending")
// //       .length || 0;
...
// import schoolQuestionnaireService from "../services/schoolQuestionnaire.service";
// import consentFormService from "../services/consentForm.service";
// import InviteSecondParentModal from "../components/InviteSecondParentModal";
...
//   // Fetch active diagnosis & school invite status & consent form
//   const fetchStatus = useCallback(async () => {
//     try {
//       const token = await currentUser.getIdToken();
//       const diagnoses = await therapistService.getDiagnoses(childId, token);
...
//       // 🆕 טעינת טופס ההסכמה
//       const consent = await consentFormService.getByChild(childId, token);
//       console.log("🔍 CONSENT FORM RESPONSE:", consent); // ← הוסיפי את זה
...
//         // 🆕 טופס הסכמה
//         const registeredParent = consentForm?.parents?.find(
//           (p) => p.role === "registered",
//         );
//         const isRegisteredSigned = registeredParent?.signed;
//         const formStatus = consentForm?.status;
...
//                     (p) => p.role === "external",
//                   );
//                   const hasInvitedSecond = !!externalParent;
//                   const isSecondSigned = externalParent?.signed;
...
//                       {/* כפתור ראשי - חתימה של ההורה הרשום */}
//                       <button
//                         onClick={() => setIsConsentModalOpen(true)}
//                         disabled={isRegisteredSigned}
...
//                       {/* 🆕 כפתור משני - הזמנת הורה שני (רק אחרי שההורה הרשום חתם) */}
//                       {isRegisteredSigned && !isSecondSigned && (
//                         <button
//                           onClick={() => setIsInviteSecondParentOpen(true)}
//                           className="w-full py-3 rounded-xl font-bold border-2 border-purple-300 text-purple-700 hover:bg-purple-50 transition-all"
//                         >
//                           {hasInvitedSecond
//                             ? "🔄 שלח שוב להורה השני"
//                             : "📨 שלח להורה השני"}
...
//                       {/* סטטוס ההורה השני */}
//                       {isSecondSigned && (
//                         <div className="w-full bg-green-50 border border-green-100 rounded-xl p-3 text-sm text-green-800">
//                           ✅ {externalParent.name} חתם על הטופס
//                         </div>
//                       )}
//                     </div>
//                   );
...
//                       ? formStatus === "fully_signed"
//                         ? "הטופס נחתם במלואו ע״י שני ההורים."
//                         : "חתמת על הטופס. ניתן לשלוח להורה השני לחתימה."
//                       : "אישור הורים לעריכת האבחון הפסיכולוגי."}
//                   </p>
//                   <button
//                     onClick={() => setIsConsentModalOpen(true)}
...
//                     }`}
//                   >
//                     {isRegisteredSigned ? "כבר חתום" : "🖊️ למילוי הטופס"}
//                   </button>
//                 </div>
//               )} */}
//             </div>
...
//       {/* 🆕 מודאל הזמנת הורה שני */}
//       <InviteSecondParentModal
//         isOpen={isInviteSecondParentOpen}
//         onClose={() => setIsInviteSecondParentOpen(false)}
//         consentForm={consentForm}
//         onSent={fetchStatus}
//       />
//     </div>
