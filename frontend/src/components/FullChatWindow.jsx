                  ...
                  <div
                    className={`p-4 rounded-2xl shadow-sm ${
                      isMe
                        ? "bg-blue-600 text-white rounded-br-none"
                        : "bg-gray-100 text-gray-800 rounded-bl-none border border-gray-200"
                    } ${msg.urgent ? "ring-2 ring-red-400" : ""}`}
                  >
                    {msg.urgent && (
                      <div
                        className={`flex items-center gap-1 text-[11px] font-bold mb-1 ${
                          isMe ? "text-red-100" : "text-red-600"
                        }`}
                      >
                        🚨 סומן כדחוף
                      </div>
      ...
      <div className="p-4 bg-gray-50 border-t shrink-0">
        ...
        <form onSubmit={handleSend} className="flex gap-2">
          <input
            ...
            onChange={(e) => setInputText(e.target.value)}
            placeholder="הקלידו תשובה..."
            className={`flex-1 border rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 bg-white ${
              isUrgent
